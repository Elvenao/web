document.addEventListener('DOMContentLoaded', (event) => {
    const elements = document.querySelectorAll('.Inyeccion');
    ...
    elements.forEach(element => {
        ...
        if (pelicula) {
            element.innerHTML = `
                <img class="Cartel-Individual" src="${pelicula.Cartel}" alt="${pelicula.Nombre}">
                <div class="Descripcion-contenedor">
                    <div class="Titulo-contenedor">
                        <h2 class="Titulo2">${pelicula.Nombre}</h2>
                    <div>
                    ...
                    <div class="contenedor-horario">
                        <button class="botones-horario" >7:00</button>
                        <button class="botones-horario" >9:00</button>
                        <button class="botones-horario" >9:30</button>
                        <button class="botones-horario">11:00</button>
                        <button class="botones-horario" >13:00</button>
                        <button class="botones-horario" >14:00</button>
                        <button class="botones-horario" >15:30</button>
                        <button class="botones-horario" >16:30</button>
                        <button class="botones-horario">17:00</button>
                        <button class="botones-horario">18:00</button>
                        <button class="botones-horario">20:00</button>
                    </div>
                </div>
            `;
        }
...
const direccion = new Array("ElClubdelosVandalos.html","ClubCero.html","Inmaculada.html","Intensamente2.html", "LosExtraños.html", "MiNombreEraEileen.html","MiVillanoFavorito.html", "Observados.html", "UnLugarEnSilencio.html", "BadBoys.html", "ElUltimoConjuro.html","Hachiko.html", "HerenciaSiniestra.html", "LaFavoritadelRey.html", "Exhuma.html","ElUltimoEscape.html", "Tuesday.html", "ComplicesDelEngaño.html")
